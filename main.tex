...
\end{frame}
	...
	\begin{frame}[fragile]{Estrutura do documento\footnote{Para mais informações sobre a estrutura de documentos \LaTeX\ -- \textcite{LaTeXDocumentStructure}}}
		\begin{columns}
			...
			\column{0.5\textwidth}
				\begin{figure}
					\fbox{\includegraphics[width=0.7\textwidth]{figures/helloworld.PNG}}
				\end{figure}
			\end{columns}
	...
	\begin{frame}[fragile]{Imagem e legenda - environments e floats}
		...
		\begin{columns}
			\column{0.48\textwidth}
				...
				\end{lstlisting}
			\column{0.3\textwidth}
				\fbox{\includegraphics[width=\textwidth]{examples/figure_example/example-figure.pdf}}
		\end{columns}
	\end{frame}
	...
	\begin{frame}[fragile]{Notação matemática}
		\begin{columns}
			\column{0.5\textwidth}
				...
				\end{lstlisting}
			\column{0.5\textwidth}
				\fbox{\includegraphics[width=0.65\textwidth]{examples/math/mathexample.PNG}}
		\end{columns}
...
\section{Bibliografias}
	...
	\begin{frame}{Modelos}
		...
		\begin{itemize}
			\item 
			\item \href{https://www.overleaf.com/project/62433019419a03edbbf67c90}{\textcolor{blue}{Link para o projeto do artigo no \emph{Overleaf}}}
			\item \href{https://github.com/omanuelcosta/Mini-curso_LaTeX}{\textcolor{blue}{Link para a página de download no Github desta apresetação e dos códigos fonte}}
		\end{itemize}
